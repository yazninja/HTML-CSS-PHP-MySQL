...
<li id='active'><a href='new3.php'> New </a></li>
...
<input type='text' name='b' placeholder='Quantity' required><br>
<input type='text' name='c' placeholder='Price' required><br>
<input type='text' name='d' placeholder='Company' required><br>
<select name='depa'> <option value='tech'> Food Technology </option> <option value='draft'> Mechanical Drafting </option> <option value='prom'> Programming </option>
<option value='civil'> Civil Technology </option> <option value='hard'> Computer Hardware Servicing </option> </select>
