...
<input type='text' name='b' placeholder='Name'><br>
<input type='text' name='c' placeholder='Quantity'><br>
<input type='text' name='d' placeholder='Price'><br>
<input type='text' name='e' placeholder='Company'><br>
<input type='text' name='f' placeholder='Type'>
